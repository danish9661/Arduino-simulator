...
run(runCli + ' project add-component ' + projNeo + ' --type openhw-neopixel --id ring');
...
run(runCli + ' project add-component ' + projSrv + ' --type openhw-servo --id servo');
run(runCli + ' project add-component ' + projSrv + ' --type openhw-potentiometer --id pot');
