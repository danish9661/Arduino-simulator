...
function TopToolboxInternal(props) {
  ...
  const toolMenuItems = [
    ...
    { 
      label: 'Export', 
      submenu: [
        { label: 'PNG (Legacy)', onClick: downloadPng },
        { label: 'PNG (WASM)', onClick: downloadPngWasm },
