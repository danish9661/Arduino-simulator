      ...
      <div className="auth-shell auth-shell--wide">
        ...
        <section className="auth-showcase">
          ...
          <p className="auth-showcase__copy">
            Explore, design, and simulate hardware projects in minutes. Sign in
            to sync your work across all devices.
          </p>
          ...
          <div className="auth-showcase__highlights">
            <div className="auth-showcase__card">
              ...
              <span>
                Experience a lag-free simulation environment tailored for
            ...
            <div className="auth-showcase__card">
              ...
              <span>
                Continue as guest to jump straight into the simulator without an
                account.
              </span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            >
              <svg viewBox="0 0 24 24" className="h-5 w-5" aria-hidden="true">
                <path
                  fill="#EA4335"
                  d="M12 10.2v3.9h5.5c-.2 1.3-1.5 3.9-5.5 3.9-3.3 0-6-2.7-6-6s2.7-6 6-6c1.9 0 3.1.8 3.9 1.5l2.7-2.6C17 3.2 14.8 2.2 12 2.2 6.8 2.2 2.6 6.4 2.6 11.6S6.8 21 12 21c6.9 0 9.5-4.8 9.5-7.3 0-.5-.1-.9-.1-1.3H12z"
                />
              </svg>
              Google
              {lastUsedLogin === "google" && (
