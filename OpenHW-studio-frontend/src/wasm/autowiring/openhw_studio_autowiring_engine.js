 ...
 * @param {any} pins_json
 */
export function ingestComponent(id, kind, x, y, w, h, pins_json) {
    const ptr0 = passStringToWasm0(id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(kind, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    wasm.ingestComponent(ptr0, len0, ptr1, len1, x, y, w, h, pins_json);
}
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./openhw_studio_autowiring_engine_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('openhw_studio_autowiring_engine_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
