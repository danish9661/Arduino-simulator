...
|-----------|----------|--------|
| LCD2004 + Pico | I2C text display | ✅ textContent captured |
| SSD1306 + Pico | I2C OLED | ✅ pixelData captured |
| Servo + Timer | Angle changes | ✅ angle metric captured |
| Sensor + ADC | Value changes | ✅ custom metric captured |
| Multiple displays | Parallel I2C | ✅ All captured independently |
...
LCD telemetry: ✓ textContent captured
            ✓ backlight status captured
