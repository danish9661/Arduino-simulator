...
**Issue #1: Variable Time Drift Tolerance by Speed** ❌
```
...
**Issue #2: Inconsistent Event Capture** ❌
```
...
**Issue #3: Different Report Times by Speed** ❌
```
...
### Change 1: Fixed 400ms Tolerance for ALL Speeds ✅
...
### Change 2: Wall-Clock Polling (Not Simulation-Time) ✅
...
### Change 3: Deterministic Snapshot Alignment ✅
...
if (alignedNowMs - lastPollSimMs < pollIntervalMs) { continue; }  // 25-20 = 5ms ✓
lastPollSimMs = alignedNowMs;
```
...
### After Deployment ✅ (Next: Validation)
...
**Net Result**: ✅ All speeds now grade fairly, consistently, and deterministically
