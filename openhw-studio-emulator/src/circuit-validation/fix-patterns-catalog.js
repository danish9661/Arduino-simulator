/**
 * Universal Fix Patterns Catalog
 * Comprehensive library of circuit fixes for common design errors.
 */
...
export const fixPatternsCatalog = {
  ...
  missing_ground_connection: {
    ...
    steps: [ { type: 'addConnection', from: 'board:GND', to: 'component:GND', color: 'black', label: 'Ground Connection' } ],
  ...
  power_supply_missing: {
    ...
    steps: [ { type: 'addComponent', componentType: 'wokwi-dc-power', voltage: 5, position: 'near:${targetComponent}:-80:0' }, { type: 'addConnection', from: 'power_supply:+', to: 'component:VCC', color: 'red' }, { type: 'addConnection', from: 'power_supply:-', to: 'board:GND', color: 'black' } ],
  ...
  i2c_address_conflict: {
    ...
    steps: [ { type: 'findAlternateAddresses', current: '0x27', available: ['0x3C','0x3D','0x3E'], method: 'hardware-jumpers-or-software' }, { type: 'suggestion', text: 'Change I2C address in firmware or by wiring address pins as indicated.', action: 'firmware-and-hardware' } ],
  ...
  // --- PHASE 4: EMI / SIGNAL / THERMAL SUGGESTIONS ---
