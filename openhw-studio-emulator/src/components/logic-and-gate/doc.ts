...
<title>AND Gate Reference | OpenHW Studio</title>
<style>
...
<div class="content">
    <h1>AND Gate</h1>
    <p class="subtitle">A fundamental digital logic gate. Output is HIGH (1) only if both inputs are HIGH (1).</p>
    ...
    <div class="component-preview">
      <svg width="120" height="80" viewBox="0 0 90 60">
        ...
        <line x1="60" y1="30" x2="90" y2="30" stroke="#63b3ed" stroke-width="2" />
      </svg>
      <div>
        <p>The AND gate implements logical conjunction. Typical applications include masking, enable signals, and basic arithmetic circuits.</p>
      </div>
    </div>
    ...
    <table class="pin-table">
      ...
      <tr><td>OUT</td><td>Output</td><td>Logic output (A AND B).</td></tr>
    </table>

    <div class="try-section">
      <h3>▶ Try it in the Simulator</h3>
      <p>Test the AND gate with slide switches and an LED indicator.</p>
...
function openSimulator() {
  var payload = {
    board: "none",
    components: [
      { id: "and1", type: "logic-and-gate", x: 200, y: 150 }
    ],
    connections: [],
    code: ""
  };
