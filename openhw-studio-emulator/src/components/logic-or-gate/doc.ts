...
<title>OR Gate Reference | OpenHW Studio</title>
<style>
...
<div class="content">
    <h1>OR Gate</h1>
    <p class="subtitle">A fundamental digital logic gate. Output is HIGH (1) if at least one input is HIGH (1).</p>
    ...
    <div class="component-preview">
      <svg width="120" height="80" viewBox="0 0 90 60">
        ...
        <line x1="80" y1="30" x2="90" y2="30" stroke="#63b3ed" stroke-width="2" />
      </svg>
      <div>
        <p>The OR gate implements logical disjunction. It is used in alarm systems, control logic, and combining multiple enable signals.</p>
      </div>
    </div>
    ...
    <table class="pin-table">
      ...
      <tr><td>OUT</td><td>Output</td><td>Logic output (A OR B).</td></tr>
    </table>

    <div class="try-section">
      <h3>▶ Try it in the Simulator</h3>
      <p>Test the OR gate logic.</p>
...
function openSimulator() {
  var payload = {
    board: "none",
    components: [
      { id: "or1", type: "logic-or-gate", x: 200, y: 150 }
    ],
    connections: [],
    code: ""
  };
