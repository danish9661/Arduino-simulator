...
<title>XOR Gate Reference | OpenHW Studio</title>
<style>
...
<div class="content">
    <h1>XOR Gate</h1>
    <p class="subtitle">A digital logic gate. Output is HIGH (1) if the inputs are different.</p>

    <div class="component-preview">
      <svg width="120" height="80" viewBox="0 0 90 60">
        <path d="M15,10 C20,10 30,10 45,10 C60,10 85,25 85,30 C85,35 60,50 45,50 C30,50 20,50 15,50 C20,40 20,20 15,10 Z" fill="none" stroke="#63b3ed" stroke-width="2" />
        ...
        <line x1="85" y1="30" x2="90" y2="30" stroke="#63b3ed" stroke-width="2" />
      </svg>
      <div>
        <p>The XOR (Exclusive OR) gate implements logical exclusive disjunction. It is heavily used in binary addition, parity generation/checking, and cryptography.</p>
      </div>
    </div>
    ...
    <table class="pin-table">
      ...
      <tr><td>OUT</td><td>Output</td><td>Logic output (A XOR B).</td></tr>
    </table>

    <div class="try-section">
      <h3>▶ Try it in the Simulator</h3>
      <p>Test the XOR gate logic.</p>
...
function openSimulator() {
  var payload = {
    board: "none",
    components: [
      { id: "xor1", type: "logic-xor-gate", x: 200, y: 150 }
    ],
    connections: [],
    code: ""
  };
