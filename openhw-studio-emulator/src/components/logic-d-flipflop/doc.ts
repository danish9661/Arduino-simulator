...
<title>D Flip-Flop Reference | OpenHW Studio</title>
<style>
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .truth-table { width: 100%; max-width: 400px; border-collapse: collapse; margin: 20px 0; }
...
<div class="content">
    <h1>D Flip-Flop</h1>
    <p class="subtitle">Edge-triggered data flip-flop. Captures the value of D on the rising edge of the clock.</p>
    ...
    <div class="component-preview">
      ...
      <div>
        <p>The D (Data or Delay) flip-flop is a fundamental sequential logic element. It stores 1 bit of memory, passing the value of the Data (D) input to the output (Q) only on the rising edge of the Clock (CLK) signal.</p>
      </div>
    </div>

    <h2>Truth Table (Rising Edge)</h2>
    <table class="truth-table">
      <tr><th>CLK</th><th>D</th><th>Q (Next)</th><th>Q\u0304 (Next)</th></tr>
      <tr><td>↑ (Rising)</td><td>0</td><td>0</td><td>1</td></tr>
      <tr><td>↑ (Rising)</td><td>1</td><td>1</td><td>0</td></tr>
      <tr><td>0, 1, or ↓</td><td>X</td><td>No Change</td><td>No Change</td></tr>
    </table>
    ...
    <table class="pin-table">
      ...
      <tr><td>Q\u0304</td><td>Output</td><td>Inverted output (complement of Q).</td></tr>
    </table>

    <div class="try-section">
      <h3>▶ Try it in the Simulator</h3>
      <p>Test the D Flip-Flop with a clock generator and switches.</p>
