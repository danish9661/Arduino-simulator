...
export const NandGateUI = ({ state, attrs }: { state: any, attrs: any }) => {
    ...
    return (
        <svg width="90" height="60" viewBox="0 0 90 60" style={{ pointerEvents: 'none' }}>
            ...
            {/* NAND gate body — D-shape (flat left + curved right) */}
            <defs>
                <linearGradient id="nandGateFill" x1="20" y1="5" x2="65" y2="55" gradientUnits="userSpaceOnUse">
                    <stop offset="0%" stopColor="#c084fc" stopOpacity="0.15" />
                    <stop offset="100%" stopColor="#a855f7" stopOpacity="0.05" />
                </linearGradient>
            </defs>
            <path
                d="M 20,6 L 45,6 Q 66,6 66,30 Q 66,54 45,54 L 20,54 Z"
