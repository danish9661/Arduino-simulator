...
└─────────────────────────────────────────────────────────────────────────┘
                                    ↓
                 [Problem: Orphaned v2.2 worker never used]
...
```
v2.2 (grading-worker.ts)          v3.8 (grading-engine.worker.ts)
...
│ ✓ Correctly handles large metadata     │
│                                          │
│ Extract bytes after marker              │
│ TextDecoder('utf-8', {fatal: false})   │
│ ✗ Silent replacement of invalid UTF-8 │
│                                          │
│ JSON.parse(jsonStr)                     │
│ ✗ No try-catch, silent failure         │
│                                          │
